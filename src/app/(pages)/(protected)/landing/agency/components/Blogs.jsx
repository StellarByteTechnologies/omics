...
const BlogCard = ({
  ...
  return <Card className="shadow aos-init" data-aos="fade-up" data-aos-duration={duration}>
...
const Blogs = ({
  ...
  return <section className="section pt-lg-8 pt-6 pb-5 position-relative">
      <Container>
        <Row>
        ...
        <Row className="mt-5">
          {blogs.map((blog, idx) => <Col md={4} key={idx}>
              <BlogCard blog={blog} />
            </Col>)}
        </Row>
      </Container>
