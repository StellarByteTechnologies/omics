...
const Login = () => {
  return <div className="bg-gradient2 min-vh-100 align-items-center d-flex justify-content-center pt-2 pt-sm-5 pb-4 pb-sm-5">
      <Container>
                      ...
                      <div className="row">
                        <Col xs={12} className="text-center">
                          <Link href="" className="btn btn-white w-100">
                            <IconifyIcon icon="lucide:github" style={{
                            height: 20,
                            width: 20
                          }} className="icon-xs me-2" />
                            Github
                          </Link>
                        </Col>
                      </div>
