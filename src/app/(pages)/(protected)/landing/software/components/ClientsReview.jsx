...
const ClientsReview = () => {
  return <section className="pt-8 pt-sm-10 pb-lg-5 pb-4">
      <Container>
        <Row>
          <Col lg={8}>
            ...
            <ul className="list-inline mt-3 mb-4 mb-lg-0">
              ...
              return <li className="list-inline-item me-4 mb-2" key={idx}>
                    <Image src={image} alt="brand" height="32" />
                  </li>;
            })}
            </ul>
          </Col>
