      ...
      <CardBody>
        <Row>
          ...
          <Col xs="auto" className="text-end">
            <Dropdown>
              <DropdownToggle as="a" className="btn-link text-muted dropdown-toggle arrow-none" href="#" role="button" id="dropdownMenuLink-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <Row className="align-items-center pt-1">
          <Col md={6}>
            ...
            <ProgressBar variant="primary" now={85} className="mt-3" style={{
            height: 6
          }} />
          </Col>
          <Col md={6} className="mt-sm-0 mt-4">
            ...
            <ProgressBar variant="orange" now={75} className="mt-3" style={{
            height: 6
          }} />
          </Col>
        </Row>
