...
const testimonials = [{
  ...
  description: 'Have been working with CSS for over ten years and Bootstrap just makes my life easier. It is still CSS and you use flex, grid, etc. but just quicker to write and maintain.',
  image: avatar1
}, {
  name: 'Cersei Lannister',
  position: 'Senior Project Manager',
  description: 'I was bad at front-end until I discovered with Bootstrap CSS. I have learnt a lot more about design and CSS itself after I started working with Bootstrap. Creating web pages is 5x faster now.',
  image: avatar2
}, {
  name: 'John Stark',
  position: 'Engineering Director',
...
const feedbackTestimonials = [{
  name: 'John Stark',
  position: 'Engineering Director',
  description: 'It is one of the very convenient to use project manager ever! I have tried many project management apps for my daily tasks, but this one is far better than others. Simply loved it!',
  image: avatar1
}, {
  name: 'Cersei Lannister',
  position: 'Senior Project Manager',
...
const FAQContent = [{
  ...
  description: ' Yup, the marketplace license allows you to use this theme in any end products. For more information on licenses, please refere license terms on marketplace. '
}, {
...
const pricingCards = [{
  ...
  duration: 700,
  price: '99',
  features: ['Up to 6000 minutes usage time', 'Use for personal or a commercial', 'Add up to 100 attendees', 'Up to 5 teams', 'Technical support via email'],
  isPopular: true
}, {
  name: 'Enterprise',
  duration: 900,
  price: '599',
  features: ['Unlimited usage time', 'Use for personal or a commercial', 'Add Unlimited attendees', '24x7 Technical support via phone', 'Technical support via email']
}];
const footerLinks = {
  Platform: {
