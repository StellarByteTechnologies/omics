...
const Features = ({
  ...
  return <section className="my-lg-5 py-5 py-sm-7 bg-gradient2 position-relative" data-aos="fade-up">
      ...
      <Container>
        ...
        <Row className="mt-5">
          {features.map((feature, idx) => <Col lg={4} data-aos="fade-up" data-duration={600} key={idx}>
              <FeatureCard {...feature} />
            </Col>)}
        </Row>
      </Container>
