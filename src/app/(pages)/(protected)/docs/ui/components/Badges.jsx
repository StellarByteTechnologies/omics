...
const Badges = ({
  ...
  return <Card id="badges">
      <CardBody>
        ...
        return <Badge key={index.toString()} className={classNames('me-1', item === 'light' && 'text-dark')} bg={item}>
              {toSentenceCase(item)}
            </Badge>;
      })}
        ...
        return <Badge key={idx} className={clsx('me-1', 'badge-soft-' + item)} bg="">
              {toSentenceCase(item)}
            </Badge>;
      })}
      </CardBody>
